...
class FavoriteRestaurantSingleCard extends StatefulWidget {
  FavoriteRestaurantSingleCard({
    Key? key,
    required this.press,
  ...
  @override
  _FavoriteRestaurantSingleCardState createState() =>
      _FavoriteRestaurantSingleCardState();
}

class _FavoriteRestaurantSingleCardState
    extends State<FavoriteRestaurantSingleCard> {
